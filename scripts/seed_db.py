...
def seed_database():
    ...
    tickers = [
        Ticker(
            id="FPT", name="Công ty Cổ phần FPT", asset_type="stock", exchange="hose"
        ),
        Ticker(
            id="VCB", name="Ngân hàng Vietcombank", asset_type="stock", exchange="hose"
        ),
