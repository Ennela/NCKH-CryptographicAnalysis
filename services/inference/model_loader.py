...
class ModelLoader:
    ...
    def load_registered_model(self, ticker_id: str, model_name: str) -> Any:
        ...
        logger.info(f"Cache miss. Loading model '{model_registry_name}' from MLflow Registry...")
        try:
            ...
            logger.error(f"Failed to load model '{model_registry_name}' from MLflow: {str(e)}")
            ...
            raise RuntimeError(f"MLflow model not found: {model_registry_name}. Error: {str(e)}")
